    ...
    $.ajax({
        ...
        success: function(data){
            if(data.code == 0){
                ...
                Dml.fun.showValidateError($('#jsChangeEmail'), "发送验证码失败");
            }
        },
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data.code == 0){
                    ...
                    if(data.msg.nick_name){
                        _showValidateError($('#nick_name'), data.msg.nick_name);
                    } else if(data.msg.birthday){
                       _showValidateError($('#birth_day'), data.msg.birthday);
                    } else if(data.msg.address){
                       _showValidateError($('#address'), data.msg.address);
                    } else if(data.msg.mobile){
                       _showValidateError($('#mobile'), data.msg.mobile);
                    } else {
                         Dml.fun.showTipsDialog({
                            title: '保存失败',
                            h2: data.msg
