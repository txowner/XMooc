    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('school', '高校'), ('person', '个人'), ('org', '培训机构')], default='org', max_length=16, verbose_name='机构类别')),
                ('click_nums', models.IntegerField(default=0, verbose_name='点击数')),
                ('fav_nums', models.IntegerField(default=0, verbose_name='收藏数')),
                ('images', models.ImageField(default='org/default.png', max_length=128, upload_to='org/%Y/%m', verbose_name='机构logo')),
