    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick_name', models.CharField(default='coder', max_length=64, verbose_name='昵称')),
                ('birthday', models.DateField(blank=True, null=True, verbose_name='生日')),
                ('gender', models.CharField(choices=[('male', '男'), ('female', '女'), ('other', '其他')], default='other', max_length=8, verbose_name='性别')),
                ...
                ('image', models.ImageField(default='head_image/default.png', max_length=128, upload_to='head_image/%Y/%m', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.CharField(choices=[('register', '注册'), ('forget', '找回密码')], max_length=16, verbose_name='类型')),
